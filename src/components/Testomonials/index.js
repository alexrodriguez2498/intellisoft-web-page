  ...
  return (
    <Section>
      <Container style={{ position: "relative" }}>
        ...
        <ul style={{height: '15rem', display: 'flex', overflowX: 'auto' }}>
          <li style={{width: '10rem', margin: '0 2rem'}}><div>hello world</div></li>
          <li style={{width: '10rem', margin: '0 2rem'}}>hello world</li>
          <li style={{width: '10rem', margin: '0 2rem'}}>hello world</li>
          <li style={{width: '10rem', margin: '0 2rem'}}>hello world</li>
          <li style={{width: '10rem', margin: '0 2rem'}}>hello world</li>
          <li style={{width: '10rem', margin: '0 2rem'}}>hello world</li>
